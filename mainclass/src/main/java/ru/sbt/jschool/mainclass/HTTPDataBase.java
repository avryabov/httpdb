package ru.sbt.jschool.mainclass;

import ru.sbt.jschool.controller.UserController;
import ru.sbt.jschool.repository.FilesUserRepository;
import ru.sbt.jschool.service.UserServiceImpl;
...
public class HTTPDataBase {
    private final static String DEFAULT_DIR = "mainclass/src/main/resources/config.properties";
